...
This chaos action Injects packet dupication on the specified container by starting a traffic control (tc) process with netem rules to add disrupt network connectivity to kubernetes pods. Check <a href="https://docs.litmuschaos.io/docs/pod-network-duplication/">pod network duplication docs</a> for more info.To know more and get started with chaos-actions visit <a href="https://github.com/litmuschaos/github-chaos-actions/blob/v0.4.x/README.md">github-chaos-actions</a>.
